...
/**
 * DAO de vehículos. Maneja consultas sobre la tabla Vehiculos.
 */
public class VehiculoDAO {

    /**
     * Retorna todos los vehículos registrados.
     * Cada elemento del listado es un arreglo: [id, placa, modelo, estado].
     */
    ...
    /**
     * Cuenta cuántos vehículos tienen estado 'Operativo'.
     */
