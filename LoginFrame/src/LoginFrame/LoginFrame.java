...
public class LoginFrame extends JFrame {
    ...
    public LoginFrame() {
        ...
        setUndecorated(true);
        setShape(new RoundRectangle2D.Double(0, 0, 420, 500, 20, 20));
        initUI();
    }
    ...
    private JTextField makeTextField() {
        ...
        f.setOpaque(false); f.setBorder(new EmptyBorder(10,14,10,14));
        f.setFont(Tema.FONT_SANS.deriveFont(14f)); f.setForeground(Tema.TEXT_PRIMARY);
