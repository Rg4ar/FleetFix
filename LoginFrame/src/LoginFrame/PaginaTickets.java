...
public class PaginaTickets extends JPanel {
    ...
    private void initUI() {
        ...
        titles.add(title); titles.add(Box.createVerticalStrut(4)); titles.add(sub);
        ...
        if (usuario.equals("admin")) {
            ...
            btnCambiar.setOpaque(false); btnCambiar.setContentAreaFilled(false);
            btnCambiar.setBorderPainted(false); btnCambiar.setFocusPainted(false);
