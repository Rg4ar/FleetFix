 ...
 * Muestra tarjetas con métricas clave y una tabla con los últimos 5 tickets.
 */
public class PaginaDashboard extends JPanel {
    ...
    public PaginaDashboard() {
        ...
        // Tarjetas de métricas en una fila de 4 columnas
        ...
        // Sección de tabla de tickets recientes
        ...
        // Solo mostrar los 5 tickets más recientes
    ...
    /** Crea el encabezado de sección con título y subtítulo. */
    ...
    /** Crea una tarjeta de métrica con etiqueta, valor numérico y color. */
    ...
    /**
     * Construye un JTable estilizado con el tema oscuro y renderers de color por estado.
     * Es estático para ser reutilizable desde PaginaTickets.
     */
    static JTable buildTable(DefaultTableModel model) {
        ...
        // Renderer para columnas con valores de estado (colorea según el valor)
        ...
        // Renderer base para columnas de texto normal
        DefaultTableCellRenderer baseRenderer = new DefaultTableCellRenderer() {
            @Override public Component getTableCellRendererComponent(JTable t, Object v,
                    boolean sel, boolean foc, int row, int col) {
                JLabel l = (JLabel) super.getTableCellRendererComponent(t, v, sel, foc, row, col);
                l.setBackground(sel ? new Color(71, 180, 255, 30) : Tema.BG_CARD);
                l.setForeground(col == 0 ? Tema.TEXT_MUTED : Tema.TEXT_PRIMARY); // ID en gris, resto en blanco
        ...
        // Asignar el renderer correcto a cada columna
    ...
    /** Envuelve un JTable en un JScrollPane con el estilo del tema. */
